...
Date: 2023-05-15
Description: EDA, Visualization, Stat Analysis, GRU Model - Chaotic Series Forecasting
"""
...
class Parameters():
    ...
    def __init__(self):
        ...
        # model description
        self.description = 'GRU - MackeyGlass'
        ...
        # trained model path
        self.model_path    = 'models/GRU32x32_b512_l20_PROPER.pth'
        # patience
        self.patience      = 100
...
class GRUForecast(nn.Module):
    ...
    def forward(self, input_seq):
        gru1_out, _ = self.gru1(input_seq)
        gru2_out, _ = self.gru2(gru1_out)
        predictions = self.fc(gru2_out[:, -1, :])  # take the last output of each sequence in the batch
        return predictions
