...
Date: 2023-05-15
Description: EDA, Visualization, Stat Analysis, CATBOOST Model - Chaotic Series Forecasting
"""
...
class Parameters():
    ...
    def __init__(self):
        ...
        # model description
        self.description = 'CATBOOST - MackeyGlass'
        ...
        # trained model path
        self.model_path    = 'LSTM32x32_b512_l20.pth'
        # patience
        self.patience      = 100
...
class CatBoostForecast:
    def __init__(self, num_leaves=15, learning_rate=0.1, n_estimators=100):
        self.model = cb.CatBoostRegressor(iterations=n_estimators, learning_rate=learning_rate, depth=num_leaves)
    
    def train(self, train_data, train_labels):
        train_pool = cb.Pool(train_data, train_labels)
