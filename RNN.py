...
Date: 2023-05-15
Description: EDA, Visualization, Stat Analysis, RNN Model - Chaotic Series Forecasting
"""
...
class Parameters():
    ...
    def __init__(self):
        ...
        # trained model path
        self.model_path    = 'RNN32x32_b512_l20_PROPER.pth'
        # patience
        self.patience      = 100
...
class RNNForecast(nn.Module):
    ...
    def forward(self, input_seq):
        rnn1_out, _ = self.rnn1(input_seq)
        rnn2_out, _ = self.rnn2(rnn1_out)
        predictions = self.fc(rnn2_out[:, -1, :])  # take the last output of each sequence in the batch
        return predictions
